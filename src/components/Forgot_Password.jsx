...
import { Grid, Box, Image, Heading, Text, FormControl, Input , Link ,Button} from '@chakra-ui/react'
    ...
    <Grid align='center' mt='75'>
        <Box >
            ...
            <Text>
             ...
             <FormControl > 
                  <Input type='email' placeholder ="simeonfriday635@gmail.com" variant='filled' w={400}/> 
              </FormControl>
